...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h2>Ja é cadastrado, faça aqui seu Login!</h2>\n");
      out.write("\t\t\t\t\t\t\t\n");
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t<h3>\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"login\" value=\"\"\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Username or Email\" id=\"usuario\">\n");
      out.write("\t\t\t\t\t\t\t</h3><br/>\n");
      out.write("\t\t\t\t\t\t\t<h3>\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"password\" name=\"password\" value=\"\"\n");
      out.write("\t\t\t\t\t\t\t\t\tplaceholder=\"Password\" id=\"senha\">\n");
      out.write("\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t<h3 class=\"remember_me\">\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<p class=\"submit\"><input type=\"submit\" class=\"btn btn-primary\" name=\"commit\"\n");
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"Login\">\n");
      out.write("\t\t\t\t\t\t\t</h3><br/>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t<label>\n");
      out.write("\t\t\t\t\t\t\t\t\t<h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t\tDeseja que o site salve sua senha.<input type=\"checkbox\"\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"remember_me\" id=\"remember_me\">\n");
      out.write("\t\t\t\t\t\t\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\t\t\t<div id=\"login-help\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tEsqueceu sua senha? <a href=\"login\">Clique aqui!</a>.\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tAinda não possui cadastro? <a href=\"cadastro\">Cadastre-se!</a>.\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</p>\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t</div> <script src=\"js/bootstrap.min.js\"></script> <script\n");
      out.write("\t\t\t\t\t\tsrc=\"js/jquery.js\"></script> <script>\n");

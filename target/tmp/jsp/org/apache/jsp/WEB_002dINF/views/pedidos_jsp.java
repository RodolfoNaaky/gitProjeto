...
public final class pedidos_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<div align=\"center\" id=\"pedidos\">\n");
      out.write("\t\t\t\t\t\t\t<h4>\n");
      out.write("\t\t\t\t\t\t\t\tAcompanhe aqui os seus Pedidos!<br /> Desculpe, você não tem\n");
      out.write("\t\t\t\t\t\t\t\tnenhum pedido pendente.\n");
      out.write("\t\t\t\t\t\t\t</h4>\n");
